          ...
          <div class="audio-wrapper" role="presentation">
            <div class="audio-customize-card">
              <button
                ...
                onclick={() => {
                  audioLayoutMode =
                    audioLayoutMode === "retro" ? "modern" : "retro";
                ...
                >
                  {#if audioLayoutMode === "retro"}
                    <CdVisual
                      ...
                      color={cdColor}
                      onCenterClick={() =>
                        (showCdColorPicker = !showCdColorPicker)}
                    />
                          ...
                          <div class="retro-controls-row">
                            ...
                            <div class="audio-controls-right">
                              <div class="audio-right-controls-card">
                                  ...
                                  {#if playbackUI.volumeSliderMode && (playbackUI.volumeHovered || playbackUI.volumeDragging)}
                                    ...
                                    >
                                      <div
                                        ...
                                        onmouseenter={() =>
                                          playbackUI.showVolumeSliderTooltip(
                                            volumeTrackEl,
                                            true,
                                          )}
                                      ...
                                      >
                                        <div
                                          ...
                                          style="height: {playbackUI.volumeSliderValue *
                                            100}%"
                                        ></div>
                                        {#each [0, 50, 100] as pct}
                                          <div
                                            ...
                                            onclick={(e) => {
                                              e.stopPropagation();
                                              playbackUI.handleVolumeSliderChange(
                                                pct / 100,
                                              );
                                            }}
                                            onkeydown={(e) => {
                                        ...
                                        <div
                                          ...
                                          style="bottom: {playbackUI.volumeSliderValue *
                                            100}%"
                                        ></div>
                                      </div>
                                    </div>
                                  {:else if playbackUI.volumeHovered || playbackUI.volumeDragging}
                                    ...
                                    >
                                      <div
                                        ...
                                        onmousedown={(e) =>
                                          playbackUI.startVolumeDrag(e, true)}
                                        onmousemove={(e) =>
                                          playbackUI.handleVolumeDiamondHover(
                                            e,
                                            true,
                                          )}
                                        role="presentation"
                                ...
                                <!-- Playback speed control: button + vertical slider -->
                                <div
                                  class="speed-control"
                                ...
                                >
                                  <button
                                    class="retro-slider-btn tooltip-ctrl"
                                    class:active={playbackUI.playbackSpeed !==
                                      1}
                                    data-tooltip="Playback speed"
                                    aria-label="playback speed"
                                    onclick={() =>
                                      playbackUI.setPlaybackSpeed(1)}
                                    oncontextmenu={(e) => {
                                      e.preventDefault();
                                      e.stopPropagation();
                                      speedTrackEl = null;
                                  ...
                                  {#if playbackUI.speedSliderMode && (playbackUI.speedHovered || playbackUI.speedDragging)}
                                    ...
                                    >
                                      <div
                                        ...
                                        onpointerdown={(e) => {
                                          if (speedTrackEl)
                                            playbackUI.startSpeedSliderDrag(
                                              e,
                                              speedTrackEl,
                                              true,
                                            );
                                        ...
                                        onmouseenter={() =>
                                          playbackUI.showSpeedSliderTooltip(
                                            speedTrackEl,
                                            true,
                                          )}
                                      ...
                                      >
                                        <div
                                          class="retro-slider-fill-vertical"
                                          style="height: {playbackUI.speedSliderValue *
                                            100}%"
                                        ></div>
                                        ...
                                        <div
                                          class="retro-slider-scrubber-vertical"
                                          style="bottom: {playbackUI.speedSliderValue *
                                            100}%"
                                        ></div>
                                      </div>
                                    </div>
                                  {:else if playbackUI.speedHovered || playbackUI.speedDragging}
                                    ...
                                    >
                                      <div
                                        ...
                                        onmousedown={(e) =>
                                          playbackUI.startSpeedDrag(e, true)}
                                        onmousemove={(e) =>
                                          playbackUI.handleSpeedDiamondHover(
                                            e,
                                            true,
                                          )}
                                        role="presentation"
                                      >
                                        {#each [0.25, 0.5, 0.75, 1, 1.25, 2, 3] as step, i}
                                          ...
                                          <button
                                            ...
                                            style="--i: {6 - i}"
                                            onclick={() =>
                                              playbackUI.setPlaybackSpeed(step)}
                  ...
                  {:else}
                    ...
                    <div
                      class="audio-info-row"
                      class:expanded={cassetteFilenameOverflow}
                      bind:this={cassetteInfoRowEl}
                    >
                      <button
                      ...
                      <span class="audio-info-filename"
                        ><Marquee
                          text={fileName}
                          class="audio-marquee"
                          measureWidth={cassetteInfoRowEl
                            ? cassetteInfoRowEl.clientWidth / 3
                            : undefined}
                          onOverflow={(v) => (cassetteFilenameOverflow = v)}
                        /></span
                      >
                      <button
                        class="audio-info-time tooltip-ctrl"
                              ...
                              {#if playbackUI.volumeSliderMode && (playbackUI.volumeHovered || playbackUI.volumeDragging)}
                                ...
                                >
                                  <div
                                    ...
                                    style="width: {playbackUI.volumeSliderValue *
                                      100}%"
                                  ></div>
                                  {#each [0, 50, 100] as pct}
                                    <div
                                  ...
                                  <div
                                    ...
                                    style="left: {playbackUI.volumeSliderValue *
                                      100}%"
                                  ></div>
                                </div>
                              {:else if playbackUI.volumeHovered || playbackUI.volumeDragging}
                            ...
                            >
                              ...
                              {#if playbackUI.speedSliderMode && (playbackUI.speedHovered || playbackUI.speedDragging)}
                                ...
                                >
                                  <div
                                    class="playback-slider-fill"
                                    style="width: {playbackUI.speedSliderValue *
                                      100}%"
                                  ></div>
                                  {#each [{ step: 0.1, pct: 0 }, { step: 1, pct: 50 }, { step: 3, pct: 100 }] as marker}
                                    <div
                                  ...
                                  <div
                                    class="playback-slider-scrubber"
                                    style="left: {playbackUI.speedSliderValue *
                                      100}%"
                                  ></div>
                                </div>
                              {:else if playbackUI.speedHovered || playbackUI.speedDragging}
