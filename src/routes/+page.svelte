          ...
          <div class="audio-wrapper" role="presentation">
            <div class="audio-customize-card">
              <button
                ...
                data-tooltip={audioLayoutMode === "retro" ? "Swap to Cassette" : "Swap to Vinyl"}
                onclick={() => {
                  audioLayoutMode = audioLayoutMode === "retro" ? "modern" : "retro";
                  saveAudioLayoutMode(audioLayoutMode);
                }}
                aria-label={audioLayoutMode === "retro" ? "Swap to cassette layout" : "Swap to vinyl layout"}
              >
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <rect x="8" y="8" width="14" height="14" rx="2" />
                  <rect x="2" y="2" width="14" height="14" rx="2" fill="var(--bg-elevated)" stroke="currentColor" />
                </svg>
              </button>
            </div>
            <audio
                      ...
                      {#if playbackUI.volumeSliderMode && (playbackUI.volumeHovered || playbackUI.volumeDragging)}
                        ...
                        >
                          <div
                            ...
                            onpointerdown={(e) => { if (volumeTrackEl) playbackUI.startVolumeSliderDrag(e, volumeTrackEl, true); }}
                            oncontextmenu={(e) => { e.preventDefault(); e.stopPropagation(); volumeTrackEl = null; toggleVolumeSliderMode(); }}
                            onmouseenter={() => playbackUI.showVolumeSliderTooltip(volumeTrackEl, true)}
                      ...
                      {#if playbackUI.speedSliderMode && (playbackUI.speedHovered || playbackUI.speedDragging)}
                        ...
                        >
                          <div
                            ...
                            onpointerdown={(e) => { if (speedTrackEl) playbackUI.startSpeedSliderDrag(e, speedTrackEl, true); }}
                            oncontextmenu={(e) => { e.preventDefault(); e.stopPropagation(); speedTrackEl = null; toggleSpeedSliderMode(); }}
                            onmouseenter={() => playbackUI.showSpeedSliderTooltip(speedTrackEl, true)}
